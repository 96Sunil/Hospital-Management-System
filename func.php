                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="doctor" class="form-control" >
                     ...
                     <option value="Dr. Sunil Singh">Dr. Sunil Singh</option>
                     <option value="Dr. Tanju Kumar">Dr. Tanju Kumar</option>
                     <option value="Dr. Rahul Kumar Singh">Dr. Rahul Kumar Singh</option>
                     <option value="Dr. Punam Shaw">Dr. Punam Shaw</option>
                      <option value="Dr. Ashok Goyal">Dr. Ashok Kumar Singh</option> -->
                      <?php display_docs();?>
