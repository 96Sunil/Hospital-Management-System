          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Neurosurgeon" name="spec">Neurosurgeon</option>
                      <option value="Orthopaedic and Joint Replacement Surgeon" name="spec">Orthopaedic and Joint Replacement Surgeon</option>
                      <option value="Pediatrician" name="spec">Pediatrician</option>
                      <option value="Cardiac Surgeon" name="spec">Cardiac Surgeon</option>
                      <option value="Spine Surgeon" name="spec">Spine Surgeon</option>
                      <option value="Cardiac Surgeon" name="spec">Cardiac Surgeon</option>
                      <option value="Dental" name="spec">Dental</option>
                    </select>
                    </div><br><br>
