...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Welcome to Dashboard  &nbsp<?php echo $username ?> 
   </h3>
    <div class="row">
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-8">
                    ...
                    <select name="apptime" class="form-control" id="apptime" required="required">
                      ...
                      <option value="16:00:00">10:00 PM</option>
                    </select>
